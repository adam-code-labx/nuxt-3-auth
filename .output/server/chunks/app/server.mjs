import { version, getCurrentInstance, reactive, h, isReadonly, defineComponent, computed, ref, resolveComponent, useSSRContext, createApp, toRef, isRef, mergeProps, defineAsyncComponent, provide, onErrorCaptured, onServerPrefetch, unref, inject } from 'vue';
...
import { u as useRuntimeConfig$1, j as createError$1, b as sendRedirect } from '../nitro/config.mjs';
...
const vueuse_head_plugin_L2fS8JV2PT = defineNuxtPlugin((nuxtApp) => {
...
const router_RCz2MEfSbu = defineNuxtPlugin((nuxtApp) => {
...
const _sfc_main = {
  ...
  __ssrInlineRender: true,
  setup(__props) {
    const ErrorComponent = defineAsyncComponent(() => import('./_nuxt/error-component-32a09aac.mjs').then((r) => r.default || r));
    const IslandRendererer = defineAsyncComponent(() => import('./_nuxt/island-renderer-10d629f8.mjs').then((r) => r.default || r));
    const nuxtApp = useNuxtApp();
...
_sfc_main.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("node_modules/.pnpm/nuxt@3.2.0_@types+node@18.13.0/node_modules/nuxt/dist/app/components/nuxt-root.vue");
